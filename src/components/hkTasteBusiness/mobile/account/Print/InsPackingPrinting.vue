            ...
            <div class="Mid">
                <div class="Info">
                   <ul>
                       ...
                       <li><span>{{$t('Enquiry.Date')}}:</span><span>{{ruleForm.CaseView.CreateDate}}</span></li>
                       ...
                       <li><span>{{$t('Enquiry.Packing')}}:</span><span>{{ruleForm.CaseView.InvcCode}}</span></li>
                ...
                <div class="Product">
                    ...
                    <div class="InnerProduct">
                            ...
                            <p class="totalSum"><span>{{$t('Enquiry.Total')}}:</span><span>{{(ruleForm.TotalAmount) | PriceFormat}}</span></p>
