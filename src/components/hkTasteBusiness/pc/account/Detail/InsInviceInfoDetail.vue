    ...
    <div class="Inner" id="print" ref="print">
        ...
        <div class="right">
            ...
            <div class="TableA Recipient">
                ...
                <div class="TotalSunm"><span>{{$t('Enquiry.TransactionAmount')}}:</span><span>{{(ruleForm.TotalAmount) | PriceFormat}}</span><span>{{$t('Enquiry.AdditionalCharges')}}:</span><span>{{(ruleForm.AdditionalFee) | PriceFormat}}</span><span>{{$t('Enquiry.Discount')}}:</span><span>{{(ruleForm.Discount) | PriceFormat}}</span><span>{{$t('Enquiry.Total')}}({{ruleForm.CurrencyCode}}):</span><span>{{(ruleForm.Total) | PriceFormat}}</span></div>
